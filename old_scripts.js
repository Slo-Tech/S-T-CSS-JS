...
var calendar =
{
	...
	prepare : function()
	{
		$('input.datetime').each(function(){
		  // uncomment this for calendar to start working
		  //new calendar.item($(this).get(0));
		});
	}
...
$(document).ready(function(){
  ...
  /* autogrow in quick replies */
//  $('#quick_answer').each(function(){
//    $(this).autogrow();
//  });
  
  $('span.ajaxcheck').each(function(){
    $(this).click(function(){ 
...
if ($('#naslovTeme')){
  $('#naslovTeme').editable({
    ...
    onSubmit: function(content) {
      ...
      if (threadid == "function") {
        var e = /threadID=\d*/
        document.location.href.match(e);
        threadid = '/t'+RegExp['$&'].substring(9);
      };
